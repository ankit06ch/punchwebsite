    ...
    <>
      ...
      <main className="relative flex grow">
        <div
          ...
          aria-hidden="true"
        >
          <div className="h-80 w-80 rounded-full bg-linear-to-tr from-[#FB7A20] opacity-70 blur-[160px]"></div>
        </div>
        ...
        <>
          ...
          <div className="relative my-6 mr-6 hidden w-[572px] shrink-0 overflow-hidden rounded-2xl lg:block">
            {/* Background */}
            <div
              className="pointer-events-none absolute left-1/2 top-1/2 -z-10 -ml-24 -translate-x-1/2 -translate-y-1/2 bg-orange-50"
              aria-hidden="true"
            >
              <Image
                src={AuthBg}
              ...
              <div className="aspect-video w-full rounded-2xl bg-gray-900 px-5 py-3 shadow-xl transition duration-300">
                ...
                <div className="font-mono text-gray-500">
                  <div className="text-center text-gray-200 mb-4">
                    ...
                    <div className="text-sm">Earn punches at your favorite spots</div>
                  </div>
                </div>
              </div>
            </div>
